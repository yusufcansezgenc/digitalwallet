...
class TransactionServiceTest {
        ...
        void testListTransactions_WalletExists_ReturnsTransactionList() {
                ...
                when(walletRepository.existsById(walletId)).thenReturn(true);
                when(walletRepository.findByCustomerId(testUserDetails.getCustomerId()))
        ...
        void testListTransactions_WalletNotFound_ReturnsNull() {
                ...
                // Act & Assert
                assertThrows(NotFoundException.class,
                                () -> transactionService.ListTransactions(walletId, testUserDetails));
                verify(walletRepository, times(1)).existsById(walletId);
        ...
        void testApproveTransaction_NonEmployeeUser_ThrowsSecurityException() {
                ...
                assertThrows(SecurityException.class,
                                () -> transactionService.ApproveTransaction(request, nonEmployeeUser));
                verify(transactionRepository, never()).save(any());
        }
        ...
        void testListTransactions_UnauthorizedWalletAccess_ThrowsSecurityException() {
                ...
                // Act & Assert
                assertThrows(SecurityException.class,
                                () -> transactionService.ListTransactions(otherWalletId, nonEmployeeUser));
        }
