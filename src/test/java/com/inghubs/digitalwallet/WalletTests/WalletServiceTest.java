...
class WalletServiceTest {
        ...
        void testListWallets_CustomerExists_ReturnsWalletList() {
                ...
                // Act
                ListWalletResponse response = walletService.ListWallets(customerId, testUserDetails);
        ...
        void testListWallets_CustomerNotFound_ThrowsNotFoundException() {
                ...
                // Assert
                assertThrows(NotFoundException.class, () -> walletService.ListWallets(customerId, testUserDetails));
                verify(customerRepository, times(1)).existsById(customerId);
        ...
        void testWithdrawWallet_WithdrawalNotActive_ThrowsException() {
                ...
                // Act & Assert
                assertThrows(WithdrawalDeniedException.class,
                                () -> walletService.WithdrawWallet(request, testUserDetails));
                verify(transactionService, never()).CreateTransaction(any());
        }
        ...
        void testWithdrawWallet_NonOwnerNonEmployee_ThrowsSecurityException() {
                ...
                assertThrows(SecurityException.class,
                                () -> walletService.WithdrawWallet(request, differentCustomerUser));
        }
